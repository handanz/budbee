...
groups = Group.create! [
  ...
  { name: "Kitten by the Sea",
    description: "Marine biology kids with special interest in kittens. We like to explore the coast looking for kittens, and to talk about creatures living in the sea.",
    city: "Oslo",
    limitation: "4",
  ...
  { name: "Linda from the other side",
    description: "Film is passion, film is life. Let's film something dope! (We usually meet at night, because we can't get up during the day...)",
    city: "Oslo",
    limitation: "4",
  ...
  { name: "Sunday Physics",
    description: "We are a group of serious physics students living in Oslo. We have fun on Sundays by gathering around the dinner table, eating pizza, and discussing unproven theories.",
    city: "Oslo",
    limitation: "4",
  ...
  { name: "Social Psychology with Hot Chocolate",
    description: "A bunch of cool kids who are really into the cultural aspect of social psychology. We usually experiment with different hot chocolates during our meet ups.",
    city: "Oslo",
    limitation: "4",
  ...
  { name: "Russian Literature",
    description: "It started with Wednesday talks on literature with Line and Jonasow. Now we are three people who meet regularly to discuss different literature topics.",
    city: "Bergen",
    limitation: "4",
  ...
  { name: "Psyche!",
    description: "Psyche! We chat about a variety of topics in psychology.",
    city: "Oslo",
    limitation: "4",
  ...
  { name: "Political Movement for All",
    description: "We are a group of students from OsloMet studying political science. On Sundays we like to take a walk in the park and discuss today's hot political topics. Join us if you'd like to share your opinions with us!",
    city: "Oslo",
    limitation: "3",
  ...
  { name: "Ocean, Books, and Cakes",
    description: "We love literature, cakes, and the ocean. You know what to expect in our meet ups ;)",
    city: "Oslo",
    limitation: "4",
  ...
  { name: "Wine and Dine",
    description: "We are a group of wine lovers. Wining and dining is life!",
    city: "Bergen",
    limitation: "4",
